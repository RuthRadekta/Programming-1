 ...
 * @author ASUS
 */
public class bukuread extends javax.swing.JFrame {

    /**
     * Creates new form bukuread
     */
    public bukuread() {
        initComponents();
     ...
     */
    public static void bukuread(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bukuread.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
